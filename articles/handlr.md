...
- [bibtex](https://www.bibtex.org/) (requires suggested package
  `bibtex`)
...
- [rdfxml](https://en.wikipedia.org/wiki/RDF/XML) (requires suggested
  package [jsonld](https://github.com/ropensci/jsonld/))
- [codemeta](https://codemeta.github.io/)
- [cff](https://citation-file-format.github.io/)
...
Instead of using the `HandlrClient`, you can use the regular functions
for each reader or writer. They are:
